...
#define	AVR_SPI_FLAG_BITBANG_ON		0x01
#define	AVR_SPI_FLAG_IOPIN_DIR_CTRL 0x02
#define	AVR_SPI_FLAG_SSPIN_HANDLE	0x04

// add port number to get the real IRQ
#define AVR_IOCTL_SPI_GETIRQ(_name) AVR_IOCTL_DEF('s','p','i',(_name))
#define AVR_IOCTL_SPI_SET_FLAGS(_name)	AVR_IOCTL_DEF('s','p','s',(_name))
#define AVR_IOCTL_SPI_GET_FLAGS(_name)	AVR_IOCTL_DEF('s','p','g',(_name))
