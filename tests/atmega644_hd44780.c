/*
	...
	Firmware side of the hd44780 read-back regression test: 4-bit
	mode, busy flag polled before every byte. D4..D7 on PB0..PB3,
	RS/E/RW on PB4/PB5/PB6, as in examples/board_hd44780.
