/*
	...
	Regression test for the hd44780 read-back defects (issue #582).
	The firmware busy-polls in 4-bit mode, wired like
	examples/board_hd44780/charlcd.c; afterwards DDRAM is compared
	against the strings the firmware wrote.
