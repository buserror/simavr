...
/* This program is very similar to test_atmega168_test.c,
 * but the AVR runs with pull-ups disabled.
 */
...
static const char *expected =
    "P<2A P<30 F<03 I<20 P<20 J<03 J<00 P<28 | K | P<B8 ";
...
int main(int argc, char **argv) {
	...
	avr = tests_init_avr("atmega48_ioport.axf");
